...
Discuss the parts of a precision medicine analysis

### Topics for later discussion
- Specifics of analyses for different endpoints
- Future analyses
...
- Placeholder for example decision tree
- Placeholder for example integer scoring model

The way that decisions are made about what treatment to recommend a patient need
to be transparent, scientifically sensible, and comprehensible to patients and
providers.
...
- The dosage to bring to Phase III can be the result of expert judgment and the
  trial results
...
We're reporting the *best* treatment recommendation, but there are likely many
ways to make recommendations that perform very similarly.
...
PLACEHOLDER TABLE for treatment assignments as randomized and following
recommendations.
...
24-week
- Outcomes: PEG only
- Interventions: combination and single treatments
