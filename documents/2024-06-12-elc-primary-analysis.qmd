...
```{r pred_beibo_importance, fig.height = 4, fig.width = 6, warning = FALSE, message = FALSE}
pred_summary_df <- FakeDataForPredictorSummary()
...
```{r trt_two_assignments, fig.height = 3, fig.width = 6, warning = FALSE, message = FALSE}
