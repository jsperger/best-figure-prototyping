...
1. Recap of past ELC discussions
2.
Start with a recap and high-level discussion before viewing the mock tables and figures for the primary analysis manuscripts.
...
### 12-week Descriptive Outcomes Figures
```{r stageone_ggbean, fig.height = 4, fig.width = 7, fig.cap='BEST Trial 12-week ITT Outcomes by Treatment Assignment'}
ggbp_one <- GGBeanPlot(
